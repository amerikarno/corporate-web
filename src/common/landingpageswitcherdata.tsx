...
export function Dark(theme:any,actionfunction:any) {
...
export function Light(theme:any,actionfunction:any) {
...
export function Ltr(theme:any,actionfunction:any) {
    actionfunction({...theme,"dir":"ltr"})
    localStorage.removeItem("Syntortl");
};
export function Rtl(theme:any,actionfunction:any) {
    actionfunction({...theme,"dir":"rtl"})
    localStorage.setItem("Syntortl", "rtl");
};

export const primaryColor1 = (theme:any,actionfunction:any) => {
...
export const primaryColor2 = (theme:any,actionfunction:any) => {
    actionfunction({...theme,
...
export const primaryColor3 = (theme:any,actionfunction:any) => {
    actionfunction({...theme,
...
export const primaryColor4 = (theme:any,actionfunction:any) => {
    actionfunction({...theme,
...
export const primaryColor5 = (theme:any,actionfunction:any) => {
    actionfunction({...theme,
...
export const backgroundColor1 = (theme:any,actionfunction:any) => {
    actionfunction({...theme,
        "bodyBg":"50 62 93",
        "darkBg":"64 76 107",
        "class":"dark",
...
export const backgroundColor2 = (theme:any,actionfunction:any) => {
    actionfunction({...theme,
        "bodyBg":"81 93 50",
        "darkBg":"95 107 64",
        "class":"dark",
...
export const backgroundColor3 = (theme:any,actionfunction:any) => {
    actionfunction({...theme,
        "bodyBg":"93 64 107",
        "darkBg":"79 50 93",
        "class":"dark",
...
export const backgroundColor4 = (theme:any,actionfunction:any) => {
    actionfunction({...theme,
        "bodyBg":"64 101 107",
        "darkBg":"50 87 93",
        "class":"dark",
...
export const backgroundColor5 = (theme:any,actionfunction:any) => {
    actionfunction({...theme,
        "bodyBg":"107 64 64",
        "darkBg":"93 50 50",
        "class":"dark",
...
//themeBackground
export const Themebackgroundcolor = ({theme,actionfunction}:any) => {
    const [state, updateState] = useState("#FFFFFF");
    const handleInput = (e: any) => {
        let { r, g, b }:any = hexToRgb(e.target.value)
        updateState(e.target.value);
...
export const LandingpageReset = (theme:any ,actionfunction: any) => {
    actionfunction({...theme,
        dir: "ltr",
        class: "light",
