  ...
  const EditableRows = ({
    ...
    return (
      <tr>
        ...
        <td>
        <button className="ti-btn ti-btn-primary me-1" type="submit">Save</button>
          <button className="ti-btn ti-btn-danger me-1" onClick={handleCancelClick}> Cancel </button>
        </td>
      </tr>
    );
  };
  const ReadOnlyRows = ({ contact, handleEditClick, handleDeleteClick }:any) => {
    return (
      <tr>
        ...
        <td>{contact.email}</td>
        <td>
        <button className="ti-btn ti-btn-primary me-1" type="button" onClick={(event) => handleEditClick(event, contact)}> Edit</button>
          <button className="ti-btn ti-btn-danger me-1" type="button" onClick={() => handleDeleteClick(contact.id)}>Delete</button>
        </td>
      </tr>
    );
  };
