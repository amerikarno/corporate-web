...
export const basicInfoSchema = z.object({
    registeredAddress: z.object({
      ...
      streetName: z.string().min(1,"please fill this field"),
      subDistrictName: z.string().min(1,"please fill this field"),
      districtName: z.string().min(1,"please fill this field"),
      provinceName: z.string().min(1,"please fill this field"),
      zipCode: z.string().min(1,"please fill this field"),
      countryName: z.string().min(1,"please fill this field"),
    }),
