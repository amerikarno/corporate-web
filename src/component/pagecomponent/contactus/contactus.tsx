...
const Contactus = () => {
	return (
		<div>
				...
				<div className= "absolute top-28 contact-help-text bannertext-center text-center space-y-3">
										...
										<div className= "mt-5">
											<div className= "space-y-4 text-start">
												...
												<div className= "grid sm:grid-cols-12 gap-x-6">
													...
													<textarea className= "col-span-9 ti-form-input" rows={4} placeholder="Enter Your Messaage"/>
												</div>
												<div className= "grid sm:grid-cols-12 gap-x-6">
