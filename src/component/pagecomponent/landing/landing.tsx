...
import { Collapsis } from "../collapse/collapse";
    ...
    <div>
      {/* <div className="landing-alert2 bg-secondary text-white fixed z-[100] w-full top-auto bottom-0">
        <div className="container mx-auto">
          <div
            id="dismiss-alert2"
            className="hs-removing:translate-x-5 hs-removing:opacity-0 transition duration-300 alert mb-0"
            role="alert"
          >
            <div className="flex">
              ...
              <div className="ltr:pl-3 rtl:pr-3 ltr:ml-auto rtl:mr-auto">
                <div className="mx-1 my-auto">
                  <button
                    type="button"
                    className="inline-flexrounded-sm  focus:outline-none focus:ring-0 focus:ring-offset-0"
        ...
        <div className="main-content landing-main !p-0" onClick={handleClick}>
                  ...
                  <div className="landing-content">
                    <div className="space-y-6">
                      <h1 className="leading-tight text-5xl font-semibold">
                        ...
                        <span className="text-secondary">Synto...!</span>
                      </h1>
                      <p className="text-lg  text-white/70 font-medium">
                        Lorem ipsum dolor sit amet consectetur, adipisicing
                        elit. Fuga aspernatur labore animi eum consequatur enim,
                        quia delectus architecto, quasi rem molestiae autem
                        cumque recusandae ratione saepe quo magni ea
                        eligendi.Fuga aspernaturlabore animi eum consequatur
                        enim, quia delectus architecto, quasi rem molestiae
                        autem cumque recusandae ratione saepe quo magni ea
                        eligendi.
                      </p>
                    </div>
                    <div className="mt-10 sm:flex justify-start sm:space-x-2 sm:space-y-0 space-y-2 rtl:space-x-reverse">
                      <Link
                        to="#"
                        className="py-3 px-3 ti-btn m-0 ti-btn-secondary"
                      >
                        See How it Works{" "}
                      ...
                      <Link
                        to="#"
                        className="py-3 px-3 ti-btn m-0 ti-btn-danger"
                      >
                        Discover More{" "}
                        <i className="ri-arrow-right-line rtl:rotate-180"></i>
                      </Link>
              ...
              <div className="grid lg:grid-cols-2 gap-6">
                ...
                <div className="my-auto">
                  <div className="space-y-2">
                    <h2 className="section-title text-center text-3xl font-bold text-gray-800 dark:text-white md:text-4xl lg:text-5xl">
                      <span className="">Mobile Responsive View</span>
                    </h2>
                    <h5 className="font-medium text-2xl text-gray-800 dark:text-white">
                      We Help to Build Your Dream Project.
                    </h5>
                    <h6 className="font-normal text-base">
                      Meet our team who are experts in Web designing and
                      Development.
                    </h6>
                    ...
                    <p className="text-base text-gray-500 dark:text-white/70">
                      ...
                      don't look even slightly believable. It uses a dictionary
                  ...
                  <Link
                    to={`${import.meta.env.BASE_URL}pagecomponent/aboutus/`}
                    className="py-2 px-3 ti-btn m-0 ti-btn-primary mt-6"
                  >
                    Read More{" "}
                    <i className="ri-arrow-right-line rtl:rotate-180"></i>
                  </Link>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="space-y-3">
                      <p className="text-base text-gray-500 dark:text-white/70">
                        ...
                        available, but the majority have suffered alteration in
                        some form, by injected humour, or randomised words which
                        don't look even slightly believable. It uses a
          ...
          <div className="section flex relative bg-[url('../img/landing/1.jpg')] bg-cover before:bg-primary/90 before:absolute before:w-full before:h-full before:top-0 before:inset-x-0">
            <div className="container mx-auto z-[0] text-center">
              ...
              <p className="w-2/3 mx-auto my-6 text-base text-white/70">
                We develop modern concepts to design and develop the interface
                design, web development to deliver them with eye-catching
                innovative ideas. We believe in effective, efficient and timely
                solutions for various types of businesses. Our team develops a
                long-term strategy to bring out spark conversation with clients,
                and visibility to your company.
              </p>
              <Link
                to={`${import.meta.env.BASE_URL}pagecomponent/Contactus/`}
                className="ti-btn m-0 py-3 px-6 ti-btn-danger"
              >
                Contact Us
              </Link>
            </div>
          ...
          <div className="bg-white dark:bg-bgdark" id="features">
            <div className="section container mx-auto space-y-6">
              <div className="text-center max-w-[80rem] mx-auto mb-12">
                <h2 className="justify-center section-title text-center text-3xl font-bold text-gray-800 dark:text-white md:text-4xl lg:text-5xl">
                  <span className="px-3">Synto Advanced Features</span>
                </h2>
                <p className="text-center text-gray-500 dark:text-white/70 text-base mt-4">
                  Most advanced features in Synto along with only javascript
              ...
              <div className="grid md:grid-cols-2 lg:!grid-cols-4">
                <div className="box mb-0 border-0 rounded-none shadow-none !bg-transparent">
                  <div className="box-body">
                    <div className="mb-3 space-y-3">
                      <div className="p-2 w-14 h-14 ltr:mr-3 rtl:ml-3 inline-flex items-center justify-center rounded-sm flex-shrink-0">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                      ...
                      <h2 className="text-gray-800 dark:text-white text-xl font-semibold my-auto mb-2">
                        Quality &amp; Clean Code
                      </h2>
                    </div>
                    <div className="flex-grow">
                      <p className="mb-3 text-base text-gray-500 dark:text-white/70">
                        In Synto code is maintained very cLearn and
                        well-structured &amp; Properly Commented.
                      </p>
                      <Link
                        className="p-0 font-semibold text-primary text-sm flex"
                        to="#"
                      >
                        Learn More
                        <i className="ri ri-arrow-right-line rtl:rotate-180 ltr:ml-3 rtl:mr-3 leading-none my-auto"></i>
                      </Link>
                    </div>
                  </div>
                </div>
                ...
                <div className="box mb-0 border-0 rounded-none shadow-none !bg-transparent">
                  <div className="box-body">
                    ...
                    <div className="flex-grow">
                      <p className=" mb-3 text-base text-gray-500 dark:text-white/70">
                        Thanks to the Tailwind framework, because it gives us
                ...
                <div className="box mb-0 border-0 rounded-none shadow-none !bg-transparent">
                  <div className="box-body">
                    ...
                    <div className="flex-grow">
                      <p className=" mb-3 text-base text-gray-500 dark:text-white/70">
                        More than 2 types of best Icons are included in this
                ...
                <div className="box mb-0 border-0 rounded-none shadow-none !bg-transparent">
                  <div className="box-body">
                    <div className="mb-3 space-y-3">
                      <div className="p-2 w-14 h-14 ltr:mr-3 rtl:ml-3 inline-flex items-center justify-center rounded-sm flex-shrink-0">
                        ...
                        >
                          <path
                            fill="#4b5563"
                            d="M5 4h6a2 2 0 1 1 0 4H5a2 2 0 1 1 0-4z"
                          ></path>
                          <path
                            fill="#9399a1"
                            d="M5 8h6a2 2 0 1 1 0 4H5a2 2 0 1 1 0-4z"
                          ></path>
                          <path
                            fill="#4b5563"
                            d="M5 12h6a2 2 0 1 1 0 4H5a2 2 0 1 1 0-4z"
                          ></path>
                          <path
                            fill="#9399a1"
                            d="M5 16h6a2 2 0 1 1 0 4H5a2 2 0 1 1 0-4z"
                          ></path>
                          <path
                            fill="#4b5563"
                    ...
                    <div className="flex-grow">
                      <p className=" mb-3 text-base text-gray-500 dark:text-white/70">
                        Variables, elements, documentation, and reusability are
                        additional features.
                      </p>
                      <Link
                        className="p-0 font-semibold text-primary text-sm flex"
                  ...
                  <div className="box-body">
                    ...
                    <div className="flex-grow">
                      <p className=" mb-3 text-base text-gray-500 dark:text-white/70">
                        ...
                        Synto admin template user can understand .
                      </p>
                      <Link
                        className="p-0 font-semibold text-primary text-sm flex"
                        to="#"
                ...
                <div className="box mb-0 border-0 rounded-none shadow-none !bg-transparent">
                  <div className="box-body">
                    ...
                    <div className="flex-grow">
                      <p className=" mb-3 text-base text-gray-500 dark:text-white/70">
                        We included five (5) types of the best possible chart
          ...
          >
            <div className="container  mx-auto z-[0]">
              <div className="text-center max-w-[80rem] mx-auto mb-12">
                <h2 className="section-title text-center text-3xl font-bold text-white md:text-4xl lg:text-5xl justify-center">
                  <span className="px-3">Why Does People Love US ...!!</span>
                </h2>
                <p className="w-2/3 mx-auto my-4 text-base text-white/70">
              ...
              <div className="grid lg:grid-cols-4 gap-0  rounded-sm">
                <div className="">
                  <div className="text-center space-y-3 p-4">
                    <p className="text-4xl text-white mb-0 font-bold">
                ...
                <div className="">
                  <div className="text-center space-y-3 p-4">
                    <p className=" text-4xl text-white mb-0 font-bold">
                      <span className="count-up" data-count="200">
                        <CountUp end={200} start={0} duration={4.94} />
                      </span>
                      +
                    </p>
                    <span className="text-lg font-semibold text-white/70">
                ...
                <div className="">
                  <div className="text-center space-y-3 p-4">
                    <p className=" text-4xl text-white mb-0 font-bold">
                      <span className="count-up" data-count="1000">
                        <CountUp end={1000} start={0} duration={4.94} />
                      </span>
                      +
                    </p>
                    <span className="text-lg font-semibold text-white/70">
                ...
                <div className="">
                  <div className="text-center space-y-3 p-4">
                    <p className=" text-4xl text-white mb-0 font-bold">
                      <span className="count-up" data-count="5">
                        5
                      </span>
                      +
                    </p>
          ...
          <div className="" id="testimonials">
            <div className="section container mx-auto">
              <div className="text-center max-w-[80rem] mx-auto mb-12">
                <h2 className="justify-center section-title text-center text-3xl font-bold text-gray-800 dark:text-white md:text-4xl lg:text-5xl">
                  <span className="px-3">What Our Clients Say ...!</span>
                </h2>
                <p className="text-center text-gray-500 dark:text-white/70 text-base mt-4">
                  Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                  Pariatur quam saepe enim maxime! Eligendi quas itaque
              ...
              <div className="grid grid-cols-12 gap-6">
                <div className="col-span-12 lg:col-span-4 my-auto">
                  <div className="space-y-3 my-auto">
                    <h2 className="section-title text-center text-3xl font-bold text-gray-800 dark:text-white md:text-4xl lg:text-5xl mb-2">
                      <span className="">Pricing Plans</span>
                    </h2>
                    <h6 className="font-medium text-xl mb-2">
                      To Get All Access Select A plan
                    </h6>
                    <p className="text-base text-gray-500 dark:text-white/70">
                      It is a long established fact that a reader will be
                      distracted by the readable content of a page when looking
                    ...
                    <Link className="ti-btn ti-btn-primary mt-3" to="#">
                      Read More
                      <i className="ri ri-arrow-right-s-line rtl:rotate-180"></i>
                    </Link>
                  </div>
                </div>
                      ...
                      <div className="shadow border dark:border-white/10 rounded-sm ">
                        <div className="p-6">
                          ...
                          <p className="text-gray-500 dark:text-white/70 text-xs">
                            Sed duo rebum et et dolores sed amet rebum magna. Et
                            sea elitr.
                          </p>
                          <div className="flex mt-4 items-baseline">
                            <span className="ltr:mr-2 rtl:ml-2 text-5xl font-semibold text-gray-800 dark:text-white">
                              $10
                            </span>
                            <span className="text-gray-500 dark:text-white/70 font-normal">
                              {" "}
                              / Month
                            </span>
                          </div>
                        ...
                        <div className="p-6 border-y border-gray-200 dark:border-white/10">
                          ...
                          <ul className="p-0 space-y-3">
                            <li className="flex space-x-4 rtl:space-x-reverse">
                              ...
                              <span className="my-auto text-gray-500 dark:text-white/70">
                                2 Free Domain Name
                              </span>
                            </li>
                            <li className="flex space-x-4 rtl:space-x-reverse">
                            ...
                            <li className="flex space-x-4 rtl:space-x-reverse">
                              ...
                              <span className="my-auto text-gray-500 dark:text-white/70">
                                Premium support:{" "}
                                <span className="ltr:ml-2 rtl:mr-2 font-semibold text-black dark:text-white">
                                  3 Months
                                </span>
                              </span>
                            </li>
                        ...
                        <div className="p-6 text-center">
                          <button
                            type="button"
                            className="ti-btn w-full ti-btn-primary m-0"
                          >
                            Get Started
                          </button>
                        </div>
          ...
          <div className="" id="team">
            <div className="section container mx-auto">
              <div className="text-center max-w-[80rem] mx-auto mb-12">
                <h2 className="justify-center section-title text-center text-3xl font-bold text-gray-800 dark:text-white md:text-4xl lg:text-5xl">
                  <span className="px-3">
                    Master Brains Behind The Project..!
                  </span>
                </h2>
                <p className="text-center text-gray-500 dark:text-white/70 text-base mt-4">
                  Lorem ipsum dolor sit, amet consectetur adipisicing elit.
              ...
              <div className="grid sm:grid-cols-5 lg:!grid-cols-9 gap-6">
                <div className="space-y-2 text-center">
                  <Link to={`${import.meta.env.BASE_URL}pagecomponent/team/`}>
                    ...
                    />
                    <div className="">
                      <h6 className="font-semibold text-base text-gray-800 dark:text-white">
                        Socrat Itumay
                      </h6>
          ...
          <div className="bg-white dark:bg-bgdark" id="faq">
            <div className="section container mx-auto">
              <div className="text-center max-w-[80rem] mx-auto mb-12">
                <h2 className="justify-center section-title text-center text-3xl font-bold text-gray-800 dark:text-white md:text-4xl lg:text-5xl">
                  <span className="px-3">Frequently Asked Questions..!</span>
                </h2>
                <p className="text-center text-gray-500 dark:text-white/70 text-base mt-4">
                  Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                  Pariatur quam saepe enim maxime! Eligendi quas itaque
              ...
              <div className="grid lg:grid-cols-2 gap-6 max-w-[80rem] mx-auto ">
                <div>
                  <div className="hs-accordion-group space-y-3">
                    <div
                      className="hs-accordion active bg-white border -mt-px rounded-sm dark:bg-bgdark dark:border-white/10"
                      id="faq-one"
                    >
                      <button
                        type="button"
                    ...
                    <div
                      className="hs-accordion bg-white border -mt-px rounded-sm dark:bg-bgdark dark:border-white/10"
                      id="faq-two"
                    >
                      <button
                        type="button"
          ...
          <div className="" id="blogs">
            <div className="section container mx-auto">
              <div className="text-center max-w-[80rem] mx-auto mb-12">
                <h2 className="justify-center section-title text-center text-3xl font-bold text-gray-800 dark:text-white md:text-4xl lg:text-5xl">
                  <span className="px-3">Latest Blog news</span>
                </h2>
                <p className="text-center text-gray-500 dark:text-white/70 text-base mt-4">
                  Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                  Pariatur quam saepe enim maxime! Eligendi quas itaque
                  ...
                  <div className="box mb-0">
                    <div className="box-body p-0">
                      <div className="relative overflow-hidden bg-no-repeat bg-cover shadow-lg rounded-sm">
                        ...
                        >
                          <div className="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed bg-black/50">
                            <div className="flex justify-start items-end h-full">
                              <div className="text-white m-6">
                                ...
                                <p className="text-gray-500 dark:text-white/70 text-sm">
                                  ...
                                  by{" "}
                                  <span className="text-white">Mark Equel</span>
                                </p>
                              </div>
                            </div>
                          </div>
          ...
          <div className="bg-white dark:bg-bgdark" id="contact">
            <div className="section container mx-auto space-y-6">
              <div className="text-center max-w-[80rem] mx-auto mb-12">
                <h2 className="justify-center section-title text-center text-3xl font-bold text-gray-800 dark:text-white md:text-4xl lg:text-5xl">
                  <span className="px-3">Feel Free To Contact Us..!</span>
                </h2>
                <p className="text-center text-gray-500 dark:text-white/70 text-base mt-4">
                  Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                  Pariatur quam saepe enim maxime! Eligendi quas itaque
                ...
                <div className="grid sm:grid-cols-2 gap-0 max-w-xl mx-auto">
                  <div className="p-6">
                    <div className="space-x-3 flex rtl:space-x-reverse items-center">
                      <div className="bg-primary/20 dark:bg-primary/20 text-primary dark:text-primary p-2 rounded-full leading-none text-center avatar avatar-sm">
                      ...
                      <div>
                        ...
                        <Link
                          to="#"
                          className="text-sm font-normal text-gray-500 dark:text-white/70"
                        >
                          {" "}
                          + 01-234-567-252-6
                        </Link>
                      ...
                      <div className="box-body">
                        <div className="my-auto text-center">
                          <div className="space-y-4 text-start">
                            ...
                            ></textarea>
                            <Link
                              className="ti-btn ti-btn-primary mb-0 w-full"
                              to="#"
                            >
                              Send Message
                            </Link>
          ...
          <div className="section flex relative bg-[url('../img/landing/1.jpg')] bg-cover before:bg-primary/90 before:absolute before:w-full before:h-full before:top-0 before:inset-x-0">
            <div className="container mx-auto z-[0] text-center space-y-5">
              ...
              <div className="max-w-md space-x-3 rtl:space-x-reverse flex justify-center mx-auto">
                ...
                <Link
                  to="#"
                  className="ti-btn m-0 p-2 px-5 ti-btn-danger whitespace-nowrap"
                >
                  Notify Me
                </Link>
              </div>
