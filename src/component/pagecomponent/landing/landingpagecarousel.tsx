...
const Basicswiperdata = [
  ...
  },
  {
    ...
    filesize: "10MB",
    Timeago: " 3 Hours ago ",
    Nameofcustomer: "Socrate itumany",
    client3: jpg60,
  },
  {
    id: 4,
    floderimg: jpg72,
    typeoffile: "Documents",
    filesize: "1.5GB",
    Timeago: "10 Hours ago ",
    Nameofcustomer: "Airi Satou",
  },
  {
    id: 5,
    floderimg: jpg73,
              ...
              <div className="box mb-0 overflow-hidden">
                <div className="box-body mb-0">
                  <div className="flex space-x-1 rtl:space-x-reverse">
                    <div className="text-yellow-500 text-base hover:text-yellow-500">
                  ...
                  <p className="text-base text-gray-500 dark:text-white/70">
                    ...
                    Tempore vel ut impedit. Sapiente id libero
                  </p>
                </div>
                  ...
                  <div className="flex justify-between">
                    <Link className="flex my-auto" to="#">
                      ...
                      <div className="ltr:pl-4 rtl:pr-4 my-auto">
                        <p className="font-semibold text-base leading-none text-gray-800 dark:text-white text-primary">
                          {items.Nameofcustomer}
                        </p>
                        <span className="dark:text-white/70 text-gray-500 text-xs">
                          Ui Developer
                        </span>
                      </div>
                    </Link>
                    <p className="text-center text-gray-500 dark:text-white/70 my-auto">
                      {items.Timeago}
                    </p>
                  </div>
                </div>
