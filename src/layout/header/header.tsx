          ...
          <div className="header-content">
            ...
            <div className="responsive-logo">
              <Link
                ...
                aria-label="Brand"
              >
                <img src={getImages("logo")} alt="logo" className="mx-auto" />
              </Link>
              <Link
                      ...
                      <div className="ti-dropdown-divider divide-y divide-gray-200 dark:divide-white/10">
                        <div className="py-2 first:pt-0 last:pb-0">
                          <div className="ti-dropdown-item">
                            <div className="flex items-center space-x-2 rtl:space-x-reverse w-full">
                              <div className="h-[1.375rem] w-[1.375rem] rounded-sm">
                                <img src={getImages("png64")} alt="flag-img" />
                              </div>
                              <div>
                          ...
                          <div className="ti-dropdown-item">
                            <div className="flex items-center space-x-2 rtl:space-x-reverse w-full">
                              <div className="h-[1.375rem] w-[1.375rem] rounded-sm">
                                <img src={getImages("png55")} alt="flag-img" />
                              </div>
                              <div>
                          ...
                          <div className="ti-dropdown-item">
                            <div className="flex items-center space-x-2 rtl:space-x-reverse w-full">
                              <div className="h-[1.375rem] w-[1.375rem] rounded-sm">
                                <img src={getImages("png56")} alt="flag-img" />
                              </div>
                              <div>
                          ...
                          <div className="ti-dropdown-item">
                            <div className="flex items-center space-x-2 rtl:space-x-reverse w-full">
                              <div className="h-[1.375rem] w-[1.375rem] rounded-sm">
                                <img src={getImages("png57")} alt="flag-img" />
                              </div>
                              <div>
                          ...
                          <div className="ti-dropdown-item">
                            <div className="flex items-center space-x-2 rtl:space-x-reverse w-full">
                              <div className="h-[1.375rem] w-[1.375rem] rounded-sm">
                                <img src={getImages("png58")} alt="flag-img" />
                              </div>
                              <div>
                          ...
                          <div className="ti-dropdown-item">
                            <div className="flex items-center space-x-2 rtl:space-x-reverse w-full">
                              <div className="h-[1.375rem] w-[1.375rem] rounded-sm">
                                <img src={getImages("png59")} alt="flag-img" />
                              </div>
                              <div>
                    ...
                    >
                      ...
                      <div className="ti-dropdown-divider divide-y divide-gray-200 dark:divide-white/10">
                        ...
                        >
                          {allData.map((idx) => (
                            <div
                              className="ti-dropdown-item relative header-box"
                              key={Math.random()}
                            >
                              <Link
                                to={`${
                                  import.meta.env.BASE_URL
                                }pagecomponent/Ecommerce/cart/`}
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="mt-2 ti-dropdown-divider">
                        ...
                        <Link
                          to={`${import.meta.env.BASE_URL}dashboards/crypto/`}
                          className="ti-dropdown-item"
                        >
