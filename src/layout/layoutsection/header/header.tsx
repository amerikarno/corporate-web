        ...
        const handleResize = () => {
            ...
            if (windowObject.innerWidth <= 991) {
                ...
                if (localStorage.Syntoverticalstyles) {
                    ...
                    const theme = store.getState()
                    ThemeChanger({...theme,
                        "toggled": `${localStorage.SyntodataToggle == 'menu-click-closed' ? 'menu-click-closed' : ''}`,
        ...
        if (window.innerWidth >= 992) {
            ThemeChanger({
                ...
                "toggled": 
                  theme.toggled === '' 
                    ? (
                        localStorage.Syntonavstyles === 'menu-click' ? 'menu-click-closed' :
                        localStorage.Syntonavstyles === 'icon-click' ? 'icon-click-closed' :
                        localStorage.Syntonavstyles === 'menu-hover' ? 'menu-hover-closed' :
                        localStorage.Syntonavstyles === 'icon-hover' ? 'icon-hover-closed' :
                        ''
                      )
                    : ''
              });
