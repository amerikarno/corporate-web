  ...
  return (
    <>
      {/* <div className="w-full flex md:justify-center">
        <div className="w-[380px] mx-auto flex flex-row px-2 md:px-0 md:space-x-6 md:w-5/6 pt-5 md:pt-10">
          <div
      ...
      <div className="w-[380px] md:w-5/6 mx-auto">
        <div className="flex flex-col lg:flex-row md:space-x-2 lg:space-x-6">
          <div className="md:w-1/2 xl:w-2/3 py-10 space-y-10">
            <Card className="bg-white rounded-[30px]">
              <CardHeader className="flex flex-row">
                <div className="w-full px-6 border-b border-gray-300">
                  <div className="flex flex-col space-y-2 md:pb-0 md:space-y-0 lg:flex-row">
                    ...
                    <div className="w-full lg:w-1/3 py-4 flex justify-center">
          ...
          <div className="md:w-1/2 xl:w-1/3 py-10">
      ...
      <div className="ml-1">
        <NavBar />
        <div className="w-full lg:max-w-[1240px] flex flex-col lg:flex-row space-y-4 lg:mx-auto">
