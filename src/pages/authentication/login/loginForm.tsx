  ...
  const onSubmit: SubmitHandler<AuthForm> = async (data) => {
    if (data.email && data.password) {
      ...
      try {
        ...
        // await sleep();
        // setCookies(
        //   "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..aTVdjvvHQiMgtY8_LmTfmz-m1gLstgcdeNJGndornVE"
        // );
        // navigate("/");
      }
    }
