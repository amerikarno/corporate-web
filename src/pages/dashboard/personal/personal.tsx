    ...
    <div>
                ...
                <div className="box-body">
                  <div className="flex justify-between">
                    ...
                    <div className="ltr:ml-auto rtl:mr-auto">
                      <span className="avatar rounded-sm bg-primary text-white p-3">
                        <i className="ri-wallet-2-line text-2xl leading-none"></i>
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="box">
                <div className="box-body">
                  <div className="flex justify-between">
                    ...
                    <div className="ltr:ml-auto rtl:mr-auto">
                      <span className="avatar rounded-sm bg-primary text-white p-3">
                        <i className="ri-currency-line text-2xl leading-none"></i>
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="box">
                <div className="box-body">
                  <div className="flex justify-between">
                    ...
                    <div className="ltr:ml-auto rtl:mr-auto">
                      <span className="avatar rounded-sm bg-primary text-white p-3">
                        <i className="ri-numbers-line text-2xl leading-none"></i>
                      </span>
                    </div>
                  </div>
                </div>
        ...
        <div className="col-span-12 xxl:col-span-3">
          <div className="box text-white overflow-hidden">
            <div className="block absolute w-full h-full before:bg-primary/70 before:absolute before:w-full before:h-full">
              <img
                src={getImages("png120")}
                alt=""
                className="w-full xxl:h-full"
              />
            </div>
              ...
              <div className="flex justify-between mb-4">
                <div className="ltr:mr-1 rtl:ml-1">
                  ...
                  <Link to="#" className="text-xs text-white/70">
                    Change
                    <i className="ri-share-forward-line text-xs ltr:ml-1 rtl:mr-1"></i>
                  </Link>
                </div>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex -space-x-2 rtl:space-x-reverse">
                          <img
                            className="inline-block avatar w-6 h-6 rounded-full"
                            src={getImages("jpg64")}
                            alt="Image Description"
                          />
                          <img
      ...
      <div className="grid grid-cols-12 gap-x-5">
                ...
                <li className="p-0 mb-5 ti-list-group border-0 text-gray-800 dark:text-white w-full">
                  <div className="flex items-start w-full">
                    <Link
                      ...
                      className="ltr:mr-2 rtl:ml-2 avatar rounded-full"
                    >
                      <img
                        src={getImages("jpg73")}
                        alt="img"
        ...
        <div className="col-span-12 md:col-span-6 xxl:col-span-3">
          <div className="box">
            <div className="box-header justify-between flex">
              <div className="box-title my-auto">Upcoming Events</div>
              <div>
                <button
                  type="button"
                  className="ti-btn m-0 rounded-sm p-1 px-3 !border border-gray-200 text-gray-400 hover:text-gray-500 hover:bg-gray-200 hover:border-gray-200 focus:ring-gray-200  dark:hover:bg-black/30 dark:border-white/10 dark:hover:border-white/20 dark:focus:ring-white/10 dark:focus:ring-offset-white/10"
        ...
        <div className="col-span-12 md:col-span-6 xxl:col-span-3">
          <div className="box">
            <div className="box-header justify-between flex">
              <div className="box-title my-auto">Quick Transfer</div>
              <div>
                <button
                  type="button"
                  className="ti-btn m-0 rounded-sm p-1 px-3 !border border-gray-200 text-gray-400 hover:text-gray-500 hover:bg-gray-200 hover:border-gray-200 focus:ring-gray-200  dark:hover:bg-black/30 dark:border-white/10 dark:hover:border-white/20 dark:focus:ring-white/10 dark:focus:ring-offset-white/10"
            ...
            <div className="box-body">
              ...
              <div className="mb-2">
                ...
                <input
                  ...
                  defaultValue="2563658568556"
                />
              </div>
              <div className="mb-2">
                <label htmlFor="input-label2" className="ti-form-label">
                  Enter Amount
                </label>
                <input
                  type="number"
              ...
              <div className="flex justify-between">
                <Link to="#" className="mb-0 w-full ti-btn ti-btn-primary">
                  Send Money
                </Link>
                <Link to="#" className="mb-0 w-full ti-btn ti-btn-danger">
                  Cancel
                </Link>
              </div>
            </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ltr:ml-auto rtl:mr-auto">
                  <nav className="flex justify-center items-center space-x-2 rtl:space-x-reverse">
                    <Link
                      className="text-gray-500 hover:text-primary e py-1 px-2 leading-none inline-flex items-center gap-2 rounded-sm"
                      to="#"
                    >
                    ...
                    <Link
                      className="bg-primary text-white py-1 px-2 leading-none inline-flex items-center text-sm font-medium rounded-sm"
                      to="#"
                      aria-current="page"
                    >
                      1
                    ...
                    <Link
                      className="text-gray-500 hover:text-primary e py-1 px-2 leading-none inline-flex items-center text-sm font-medium rounded-sm"
                      to="#"
                    >
                      2
                    </Link>
