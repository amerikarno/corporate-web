    ...
    <>
      <div className="w-full bg-body-bg-white">
          ...
          <div className="max-w-screen-s1 s2:max-w-[980px] s3:max-w-[1280px] mx-auto s2:px-[10px]">
            <div className="w-full flex flex-row py-4 px-4">
              ...
              <div className="hidden s3:flex s3:w-1/3 s3:items-center">
                <u className="s2:text-3xl font-bold text-black">
                  Elite Consulting
                </u>
              </div>

              {token ? (
                <div className="w-1/2 s3:w-1/3 flex justify-end items-center">
                  <DropdownMenu>
        ...
        <div className="w-full">
          <div className="max-w-screen-xl mx-auto grid justify-items-center grid-cols-1 s2:grid-cols-2 s3:grid-cols-3">
            {dataAll.map((item, index) => (
              <div
                className="py-2 s2:py-4 s3:py-8"
                key={index}
                onClick={() =>
